...
/******************************
******************************/
ofApp::ofApp(int _soundStream_Input_DeviceId, int _soundStream_Output_DeviceId, int _Cam_id, int _CamWidth, int _CamHeight, int _CamFps )
...
, Visualize(_Cam_id, _CamWidth, _CamHeight, _CamFps)
{
}
...
void ofApp::keyPressed(int key){
	switch(key){
		...
		case 'a':
			{
				ofColor col = Gui_Global->col_ArtSin;
				Gui_Global->col_particle = col;
				Gui_Global->col_DancingCloud = col;
			}
			break;
			
		case ' ':
			{
				Gui_Global->b_SendImg			= Gui_Global->b_DispImg;
				Gui_Global->b_SendWebCam		= Gui_Global->b_DispWebCam;
				Gui_Global->b_SendFFT			= Gui_Global->b_DispFFT;
				Gui_Global->b_SendArtSin		= Gui_Global->b_DispArtSin;
				Gui_Global->b_SendParticle		= Gui_Global->b_DispParticle;
				Gui_Global->b_SendDanceCloud 	= Gui_Global->b_DispDanceCloud;
			}
			break;
